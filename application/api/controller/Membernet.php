    ...
    public function action_single_plan($id){
     ...
     //7绑卡支付
      ...
      public function cancle_plan($generation_id){
           ...
           #1如果当天没还款且有消费成功的不能取消
           $order_back=GenerationOrder::where('order_status=1 and order_type=2')->whereTime('order_time', 'today')->find();
           $order_cash=GenerationOrder::where('order_status=2 and order_type=1')->whereTime('order_time', 'today')->find();
