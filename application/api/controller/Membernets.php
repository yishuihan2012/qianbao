...
class Membernets
{
  ...
  "ordernumber": "test201801101523"
    ...
    /**
     * @version tonglian / Api 通联收银宝商户入网接口
     * @author zlu
     * @datetime    2018-08-07 11:52:05
     * @param
     **/
    public function tonglian()
    {
        $tonglian = new \app\api\payment\Tonglian($this->passway->passageway_id, $this->member->member_id);
        $addcus   = $tonglian->addcus();
        return $addcus;
    }
}