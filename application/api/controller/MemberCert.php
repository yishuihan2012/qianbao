    ...
    public function validationNew()
    {
        ...
        if (System::getName('certhost') == 'http://yhsys.market.alicloudapi.com') {
           ...
           if(!$card_validate['data']['bankCardBin']) return ['code'=>351,'msg'=>'认证失败，请联系客服'];
            ...
            if ($card_validate['code'] != 0000) {
                return ['code' => 351, 'msg' => '实名认证失败。'];
            }

            if ($card_validate['data']['resultCode'] != 'R001') {
                return ['code' => 351, 'msg' => '认证信息不匹配或您的储蓄卡尚未开通无卡支付功能，请联系发卡行。'];
            }
