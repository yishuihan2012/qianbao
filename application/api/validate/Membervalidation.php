...
class Membervalidation extends Validate
{
	 #验证规则
      protected $rule = [
        	 ...
        	 ['card_bank_addressId', 'require', '支行没有选择~'],
        	 ['card_bankname', 'require', '银行名称找不到~'],
      ];
      #定义验证场景
     protected $scene = [
         'creat' =>  ['card_bankno','card_phone','smsCode','card_bank_province','card_bank_city','card_bank_area','card_bank_addressId','card_bankname','card_idcard'],
          'edit' =>  ['card_bankno','card_phone','smsCode','card_bank_province','card_bank_city','card_bank_area','card_bank_addressId','card_bankname'],
     ];
}