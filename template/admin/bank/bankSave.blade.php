                ...
                <div class="tab-pane fade active in" id="tab2Content1">
                  <form action="{{url('/index/Bank/bankSave/')}}" method="post" class="form-horizontal" id="myform">
                     <div class="row form-group">
                      <label for="announcement_title" class="col-sm-2 text-right"><b>银行名称</b></label>
                      <div id="announcement_title" class="col-sm-6"><input type="text" class="form-control announcement_title" name="generalize_title" placeholder="名称" value="{{$info['bank_name']}}">
                      	<input type="hidden" class="form-control announcement_title" name="bank_id" placeholder="名称" value="{{$info['bank_id']}}">
                      </div>
                     </div>

         
                     <div class="row form-group">
                      <label for="generalize_thumb" class="col-sm-2 text-right"><b>银行图标</b></label>
				     ...
				     <div id="generalize_thumb" class="col-sm-6">
				       ...
				       <input type="hidden" class="form-control generalize_thumb" name="bank_avatar" value="">
				     </div>   
				                      </div>
                     ...
                     <div class="row form-group">
                      <label for="announcement_content" class="col-sm-2 text-right"><b>状态</b></label>
                      <select name="bank_state" class="form-control" style="width:50%;">
                       <option value="1" @if($info['bank_state'] == 1) selected @endif>正常</option>
                       <option value="0" @if($info['bank_state'] == 0 ) selected @endif>停用</option>
                     </select>
