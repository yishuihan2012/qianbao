 ...
 <div class="modal-content animated fadeInLeft">
	 <form action="{{url('/index/server_model/add_model')}}" method="post" class="form-horizontal" id="myform">
	 <h2></h2>
	 <div class="row form-group">
		 <label for="generalize_title" class="col-sm-3 text-right"><b>模块名称:</b></label>
		 <div class="col-sm-6" id="generalize_title">
			 <input type="text" class="form-control generalize_title" name="item_name" placeholder="请填写模块的名称" value="">
		 </div>		
	</div>
	<div class="row form-group">
		 <label for="generalize_title" class="col-sm-3 text-right"><b>排序</b></label>
		 <div class="col-sm-6" id="generalize_title">
			 <input type="text" class="form-control generalize_title" name="share_title" placeholder="请填写排序号码" value="">
		 </div>		
	</div>
	 <div class="row form-group">
	...
	<div class="row form-group">
		 ...
		 <div id="generalize_thumb" class="col-sm-6">
			 ...
			 <input type="hidden" class="form-control generalize_thumb" name="item_icon" value="">
		 </div>		
	</div>
