<nav class="menu" data-ride="menu">
    ...
    <ul class="nav nav-primary">
        ...
        <li class="nav-parent article-manager">
            ...
            <li class="articles_category"><a href="{{url('/index/article/memberNovice')}}"> 新手指引</a></li>
            </ul>
        </li>
        ...
        <li class="nav-parent generalize-manager">
            ...
            <ul class="nav">
                ...
                <li class="generalize_share"><a href="{{url('/index/generalize/share')}}"> 分享列表</a></li>
                 <li class="generalize_share2"><a href="{{url('/index/generalize/exclusive_list')}}"> 专属列表</a></li>
            </ul>
        </li>
