...
<div class="row">
	 <form action="{{url('index/article/noviceSave')}}" method="post" class="form-horizontal" id="myform">
		 <div class="row form-group">
			...
			<div id="article_title" class="col-sm-6"><input type="text" class="form-control article_title" name="novice_name" placeholder="新手标题" value="{{$info->novice_name}}">
				<input type="hidden" class="form-control article_title" name="novice_id" placeholder="新手标题" value="{{$info->novice_id}}"></div>
		 </div>
		 <div class="row form-group">
