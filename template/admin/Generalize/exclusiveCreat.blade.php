 ...
 <div class="modal-content animated fadeInLeft"> 
	 ...
	 <div class="row form-group">
		 <label for="generalize_title" class="col-sm-3 text-right"><b>专属名称:</b></label>
		 <div class="col-sm-6" id="generalize_title">
			 <input type="text" class="form-control generalize_title" name="exclusive_name" placeholder="请填写素材的名称" value="">
		 </div>		
	</div>
	<div class="row form-group">
		 <label for="generalize_thumb" class="col-sm-3 text-right"><b>专属图片:</b></label>
