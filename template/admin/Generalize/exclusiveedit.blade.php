...
hr{margin:0 5px!important;}
  ...
  <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2Content1">
                  <form action="{{url('/index/Generalize/exclusiveedit')}}" method="post" class="form-horizontal" id="myform">
                     <div class="row form-group">
                      <label for="announcement_title" class="col-sm-2 text-right"><b>名称</b></label>
                      <div id="announcement_title" class="col-sm-6"><input type="text" class="form-control announcement_title" name="exclusive_name" placeholder="名称" value="{{$info['exclusive_name']}}">
                      	<input type="hidden" class="form-control announcement_title" name="exclusive_id" placeholder="名称" value="{{$info['exclusive_id']}}">
                      </div>
                     </div>
				     ...
				     <div id="generalize_thumb" class="col-sm-6">
				       <div id='uploaderExample3' class="uploader">
				         <div class="uploader-message text-center">
				           ...
				           <div class="uploader-files file-list file-list-grid">
									...
									<img src="{{$info['exclusive_thumb']}}" width="200" height="200">
				       ...
				       <input type="hidden" class="form-control generalize_thumb" name="exclusive_thumb" value="">
				     </div>   
				                      </div>
                  <div class="row">
                <h4></h4>
...
$(document).ready(function(){
 ...
 $('#uploaderExample3').uploader({
   ...
   onFileUploaded(file, responseObject) {
       ...
       $('.menu .nav li.generalize_share2').addClass('show');
 });
 $(function(){
    $(':input').labelauty();
 });
