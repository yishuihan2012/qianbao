<nav class="menu" data-ride="menu">
    ...
    <ul class="nav nav-primary">
        ...
        <li class="nav-parent order-manager">
            ...
            <ul class="nav">
                <li class="order"><a href="<?php echo e(url('/index/order/index')); ?>"><i class="icon icon-sliders"></i> 升级订单列表</a></li>
        ...
        <li class="nav-parent financial-manager">
            ...
            <ul class="nav">
                    <li class="financial_center"><a href="<?php echo e(url('/index/financial/index')); ?>"><i class=""></i> 对账中心</a></li>
                    <li class="commiss_center"><a href="<?php echo e(url('/index/financial/commiss')); ?>"><i class=""></i> 分佣统计</a></li>
                    <li class="fenrun_center"><a href="<?php echo e(url('/index/financial/fenrun')); ?>"><i class=""></i> 分润统计</a></li>
            </ul>
        </li>
        <li class="nav-parent model-manager">
                 <a href="#"><i class="0icon icon-cube-alt"></i> 自定义模块</a>
                 <ul class="nav">
                        <li class="model-list"><a href="<?php echo e(url('/index/server_model/index')); ?>"><i class="icon icon-th-large"></i> 模块列表</a></li>
                        <li class="model-server"><a href="<?php echo e(url('/index/server_model/service_list')); ?>"><i class="icon icon-server"></i> 服务列表</a></li>
                 </ul>
        </li>
        ...
        <li class="nav-parent article-manager">
            ...
            <ul class="nav">
                ...
                <li class="novice_calss"><a href="<?php echo e(url('/index/novice_class/index')); ?>"> 新手指引分类</a></li>
            </ul>
        </li>
        ...
        <li class="nav-parent generalize-manager">
            ...
            <ul class="nav">
                <li class="generalize"><a href="<?php echo e(url('/index/generalize/index')); ?>"> 推广素材库</a></li>
                <li class="generalize_share"><a href="<?php echo e(url('/index/generalize/share')); ?>"> 注册邀请链接</a></li>
                 <li class="generalize_share2"><a href="<?php echo e(url('/index/generalize/exclusive_list')); ?>"> 专属二维码</a></li>
            </ul>
        </li>
