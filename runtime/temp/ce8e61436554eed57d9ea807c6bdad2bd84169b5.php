 ...
 <script type="text/javascript">
 	iziToast.<?php echo e($type); ?>({
	    title: '<?php echo e($type); ?>',
	    position: 'topCenter',
	    icon:"<?php echo e($type=='success' ? 'icon-ok-sign' : ($type=='warning' ? 'icon-frown' : 'icon-remove-sign')); ?>",
	    iconColor:"<?php echo e($type=='success' ? '#38b03f' : ($type=='warning' ? '#f1a325' : '#ea644a')); ?>",
	    transitionIn: 'bounceInLeft',
	    class: "tips_<?php echo e($type); ?>",
	    color: "<?php echo e($type=='success' ? '#ddf4df' : ($type=='warning' ? '#fff0d5' : '#ffe5e0')); ?>",
